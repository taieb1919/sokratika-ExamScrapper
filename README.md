...
Créez un fichier `.env` pour personnaliser les paramètres :
...
CHUNK_SIZE=8192                # Taille des blocs de téléchargement
...
ORGANIZE_BY_SUBJECT=False      # Organiser par matière
```
...
LOG_RETENTION=30 days          # Rétention des logs
```
